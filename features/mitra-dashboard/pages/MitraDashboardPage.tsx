...
export function MitraDashboardPage({ data, userProfile }: MitraDashboardPageProps) {
  const profile = userProfile;
  const { activeMitraRole } = getActiveMitraContext(userProfile);
  ...
  return (
    <main className="min-h-screen w-full px-4 py-8 font-sans">
      <div className="mx-auto w-full px-4 space-y-8">
                ...
                <CardContent className="p-0 mt-4 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-[11px] font-semibold text-gray-400 mt-1.5 flex items-center gap-0.5">
        ...
        {/* MENGIRIM PROP showSchedule (True jika Guru atau Murid) */}
