...
import { useUpdateMitraController } from '../hooks/UpdateMitraController';
...
export function UpdateMitraPage({ mitraId }: UpdateMitraPageProps) {
  ...
  const { form, mitra, isLoading, isError, error, isSubmitting, onSubmit } = useUpdateMitraController(mitraId);
