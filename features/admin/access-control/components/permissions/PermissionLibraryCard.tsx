...
export function PermissionLibraryCard({ permissions, scope, isLoading, isError, error, userRole, onCreatePermission, onEditPermission, onDeletePermission }: PermissionLibraryCardProps) {
  return (
    <Card>
