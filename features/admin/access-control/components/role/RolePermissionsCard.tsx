...
export function RolePermissionsCard({ scope, selectedRole, selectedPermissionIds, availablePermissions, isLoading, isError, error, isSyncing, onTogglePermission, onSyncPermissions }: RolePermissionsCardProps) {
  return (
    <Card>
